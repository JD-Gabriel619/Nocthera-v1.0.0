...
import { selfCheck } from "./nocthera/bootstrap/index.js";
import { recoverAll } from "./nocthera/recovery/index.js";
import { start as startHealthMonitor } from "./nocthera/health/index.js";

class Nocthera extends Client {
  constructor() {
    super({
      intents: [
  ...
  startWebServer() {
    ...
    app.get('/', (req, res) => {
      res.status(200).json({ 
        message: 'Nocthera System Online',
        version: pkg.version,
        timestamp: new Date().toISOString()
      });
    });
