...
//
// Rules:
// 1. Commands/handlers: throw NoctheraError (via createError) or let errors propagate;
...
export function categorizeError(error) {
    if (error instanceof NoctheraError) {
        return error.type;
    }
...
export function createError(message, type = ErrorTypes.UNKNOWN, userMessage = null, context = {}) {
    ...
    return new NoctheraError(message, type, userMessage, normalizedContext);
}
